...
export const categoriasCustoT: Record<Lang, {
  headerTitle:      string
  ...
  'pt-BR': {
    ...
    headerSubtitle:   'Categorias e itens padrão oferecidos como exemplo ao criar um projeto desse tipo — editáveis aqui, sem afetar projetos já criados.',
  ...
  'en': {
    ...
    headerSubtitle:   'Default categories and items offered as an example when creating a project of this type — editable here, doesn\'t affect existing projects.',
  ...
  'es': {
    ...
    headerSubtitle:   'Categorías e ítems predeterminados ofrecidos como ejemplo al crear un proyecto de ese tipo — editables aquí, no afecta proyectos ya creados.',
