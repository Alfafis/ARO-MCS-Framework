...
> = {
  'pt-BR': {
    ...
    deleteBlockedInUse:
      'Este setor está em uso por um ou mais itens de custo. Remova-o das aplicabilidades antes de excluir.',
  ...
  en: {
    ...
    deleteBlockedInUse:
      'This sector is in use by one or more cost items. Remove it from applicabilities before deleting.',
  ...
  es: {
    ...
    deleteBlockedInUse:
      'Este sector está en uso por uno o más ítems de costo. Retíralo de las aplicabilidades antes de eliminar.',
    newSetorIdLabel: 'ID (número)',
