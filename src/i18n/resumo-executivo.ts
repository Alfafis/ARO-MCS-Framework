...
export const resumoT: Record<Lang, {
  ...
  'pt-BR': {
    ...
    fanDesc:        cv => `Faixa estimada a partir do coeficiente de variação da Aro Simulação (${cv}%) aplicado ao desembolso acumulado por ano — não é um cálculo de percentil (P10/P90) rodado independentemente para cada ano.`,
  ...
  'en': {
    ...
    fanDesc:        cv => `Range estimated from the Aro Simulação coefficient of variation (${cv}%) applied to cumulative disbursement by year — not an independent percentile (P10/P90) calculation per year.`,
  ...
  'es': {
    ...
    fanDesc:        cv => `Rango estimado a partir del coeficiente de variación de la Aro Simulação (${cv}%) aplicado al desembolso acumulado por año — no es un cálculo de percentil (P10/P90) ejecutado independientemente para cada año.`,
