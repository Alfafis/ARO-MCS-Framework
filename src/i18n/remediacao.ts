...
export const remediacaoT: Record<Lang, {
  headerTitle:          string
  ...
  'pt-BR': {
    ...
    disabledStateBody:    'Este módulo cobre investigação e reabilitação de áreas contaminadas, barragens de rejeitos e planta de tratamento. Fica separado do provisionamento principal e é opcional por projeto.',
    ...
    configToggleHint:     'Quando habilitado, o projeto ganha uma aba "Remediação" no workspace com categorias e itens em modelo próprio (quantidade × custo unitário). Não afeta o provisionamento principal.',
    revisionIncludeLabel: 'Incluir remediação nesta revisão',
    revisionIncludeHint:  'Se marcada, o portal público exibe uma seção adicional com os dados de remediação quando esta revisão estiver vigente.',
  },
  'en': {
    ...
    disabledStateBody:    'This module covers investigation and rehabilitation of contaminated areas, tailings dams and treatment plant. It stays separate from the main provisioning and is opt-in per project.',
    ...
    configToggleHint:     'When enabled, the project gains a "Remediation" tab in the workspace with categories and items in a dedicated model (quantity × unit cost). It does not affect the main provisioning.',
    revisionIncludeLabel: 'Include remediation in this revision',
    revisionIncludeHint:  'If checked, the public portal will show an additional remediation section when this revision is the current one.',
  },
  'es': {
    ...
    disabledStateBody:    'Este módulo cubre investigación y rehabilitación de áreas contaminadas, presas de residuos y planta de tratamiento. Permanece separado del provisionamiento principal y es opcional por proyecto.',
    ...
    configToggleHint:     'Cuando está habilitado, el proyecto gana una pestaña "Remediación" en el workspace con categorías e ítems en modelo propio (cantidad × costo unitario). No afecta el provisionamiento principal.',
    revisionIncludeLabel: 'Incluir remediación en esta revisión',
    revisionIncludeHint:  'Si se marca, el portal público mostrará una sección adicional con datos de remediación cuando esta revisión sea la vigente.',
  },
}
