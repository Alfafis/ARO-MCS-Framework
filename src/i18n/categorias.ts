...
export const categoriasT: Record<Lang, {
  ...
  'pt-BR': {
    ...
    custoProvavelHint:  'Moda "pela experiência" da categoria — alimenta a Triangular da Aro Simulação. Deixe vazio pra usar (min+max)/2.',
  ...
  'en': {
    ...
    custoProvavelPh:    '(min + max) / 2',
    custoProvavelHint:  'Category mode "from experience" — feeds Aro Simulação Triangular. Leave empty to use (min+max)/2.',
  ...
  'es': {
    ...
    custoProvavelPh:    '(min + max) / 2',
    custoProvavelHint:  'Moda "por experiencia" de la categoría — alimenta la Triangular de la Aro Simulação. Vacío usa (min+max)/2.',
