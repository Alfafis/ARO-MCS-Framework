...
export default function ClienteRow({ cliente, projectsLabel, onOpen }: Props) {
  return (
    <button
      onClick={onOpen}
      className="w-full grid grid-cols-[36px_1fr_auto_16px] items-center gap-3 px-6 py-4 border-b border-c-line last:border-b-0 text-left bg-transparent border-0 border-x-0 border-t-0 cursor-pointer hover:bg-c-surface-2 transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
    >
