...
): import('../src/types/categorias.ts').CategoryItem {
  return {
...
const ipca = [0.034, 0.003, 0.028, 0.031, 0.04, 0.042, 0.05, 0.03, 0.0211, 0.034]
...
const fatorAno6 = 1.034 * 1.003 * 1.028 * 1.031 * 1.04 * 1.042
...
assert.equal(
  semAno.matrix[0].slice(1).reduce((a, b) => a + b, 0),
  0,
  'demais anos zerados'
)
